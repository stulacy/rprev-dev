...
```{r, eval=T}
set.seed(17)
df <- simulate_dataset(1000, inc_rate=100, scale=10, shape=0.7, mu=65, sigma=10, pbinomial=0.51, beta=c(-0.05, -0.5),
                       rancens=T, censrate=0.0006, start_date='2003-01-01', index='2015-03-17')
...
Here is the plot of survival times for censored patients, which for some reason appears to be bi-modal, it'd be helpful to determine the source of this as otherwise this censoring pattern may not be considered random.
