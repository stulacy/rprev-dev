...
meanIR_test_dev <- function() {
  meanIR_dev(registry_data$DateOfDiag, sapply(5:13, function(x) sprintf("20%02d-09-01", x)),
...
nyear_test_dev <- function() {
  ...
  n_year_estimates_dev(N_years = 3, num_reg_years=length(registry_years)-1,
...
prevage_test_dev <- function() {
    ...
    registry_end_year = 9
    N_years = 10
    prevalence_by_age_dev(dist = post_age_dist_total, registry_end_year, N_years)
}
prevage_test_dev()
```
