#' @title Builds survival models for diseases with cured fractions using population mortality tables
#'
#' @description Placeholder
#'
#' @details To model population survival, population mortality tables are required, as specified by the \code{daily_survival}
