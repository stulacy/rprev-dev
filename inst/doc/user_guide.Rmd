...
The primary functionality of a survival model is to estimate survival probability for each individual at a specific time-point. For a Weibull model this is simply provided by $1-CDF$, with the CDF implemented already in base R as `pweibull`. 
