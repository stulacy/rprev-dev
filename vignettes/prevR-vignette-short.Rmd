...
plot(survf, lwd=1, col = c("blue","red"), main="Survival stratified by sex", xlab="Days", ylab="Probability")
...
plot(km, lwd=2, col="blue", main="Overall Survival", xlab="Days", ylab="Survival probability")
```
...
plot(km2, lwd=2, col=1:length(ages), main="Survival stratified by age", xlab="Days", ylab="Survival probability")
legend("topright", legend=substring(names(km2$strata), 25, 32), lty = 1, col=1:length(ages))
```
