...
We replace the simulated values with the observed values, for the years where registry data is available:
...
prevalence_total_2 <- prevalence_total
prevalence_total_2$simulated_cases[1:9] <- rev(observed)
n_year_estimates_current(prevalence_total_2, num_years_to_estimate = 3, population_size = 3.5e6)

n_year_estimates(prevalence_total, num_years_to_estimate = 5, population_size = 3.5e6)

prevalence_total_2 <- prevalence_total
prevalence_total_2$simulated_cases[1:9] <- rev(observed)
n_year_estimates_current(prevalence_total_2, num_years_to_estimate = 5, population_size = 3.5e6)

n_year_estimates(prevalence_total, num_years_to_estimate = 10, population_size = 3.5e6)

prevalence_total_2 <- prevalence_total
prevalence_total_2$simulated_cases[1:9] <- rev(observed)
n_year_estimates_current(prevalence_total_2, num_years_to_estimate = 10, population_size = 3.5e6)
```
