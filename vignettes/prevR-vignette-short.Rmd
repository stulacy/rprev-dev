...
It can be concluded that the disease has around 100 new cases each year. To assess consistency of the incidence data with an homogeneous Poisson process, the `sim_check` and `smoothed_incidence` functions can be used:
