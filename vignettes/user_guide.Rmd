...
Additional information about the simulation can be found in the `simulated` object, which contains a `data.table` of the simulated incident population. This can be used to quickly assess the accuracy of the model fits for both the incidence and survival processes.
